...
<doc>
    ...
    <members>
        ...
        <member name="P:NSwag.CodeGeneration.TypeScript.Models.TypeScriptClientTemplateModel.UseAbortSignal">
            <summary>Gets a value indicating whether to use the AbortSignal (Fetch/Aurelia template only, default: false).</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.TypeScript.Models.TypeScriptClientTemplateModel.IncludeHttpContext">
            <summary>Gets a value indicating whether to include the httpContext (Angular template only, default: false).</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.TypeScript.Models.TypeScriptClientTemplateModel.RequestCredentialsType">
            <summary>Gets a value indicating credential setting for an http request. (Fetch/Angular only, default: false)</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.TypeScript.Models.TypeScriptClientTemplateModel.RequestModeType">
        ...
        <member name="P:NSwag.CodeGeneration.TypeScript.Models.TypeScriptFileTemplateModel.IncludeHttpContext">
        ...
        <member name="P:NSwag.CodeGeneration.TypeScript.Models.TypeScriptFrameworkAngularModel.WithCredentials">
        ...
        <member name="P:NSwag.CodeGeneration.TypeScript.Models.TypeScriptFrameworkModel.UseDayJS">
            <summary>Gets a value indicating whether DayJS is required.</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.TypeScript.Models.TypeScriptFrameworkModel.UseLuxon">
        ...
        <member name="P:NSwag.CodeGeneration.TypeScript.Models.TypeScriptFrameworkModel.UseRxJs7">
        ...
        <member name="P:NSwag.CodeGeneration.TypeScript.Models.TypeScriptFrameworkRxJsModel.ResponseTextProperty">
        ...
        <member name="P:NSwag.CodeGeneration.TypeScript.Models.TypeScriptParameterModel.GetDateTimeToString">
            <summary>
        ...
        <member name="T:NSwag.CodeGeneration.TypeScript.RequestCredentialsType">
            <summary>Settings for the <see cref="T:NSwag.CodeGeneration.TypeScript.TypeScriptClientGenerator"/>.</summary>
        </member>
        <member name="F:NSwag.CodeGeneration.TypeScript.RequestCredentialsType.NotSet">
            https://developer.mozilla.org/en-US/docs/Web/API/RequestInit#credentials
            <summary>
            Setting will not be included.
            </summary>
        </member>
        <member name="F:NSwag.CodeGeneration.TypeScript.RequestCredentialsType.Omit">
            <summary>
            Never send credentials in the request or include credentials in the response.
            </summary>
        </member>
        <member name="F:NSwag.CodeGeneration.TypeScript.RequestCredentialsType.SameOrigin">
            <summary>
            Only send and include credentials for same-origin requests.   
            </summary>
        </member>
        <member name="F:NSwag.CodeGeneration.TypeScript.RequestCredentialsType.Include">
            <summary>
            Always include credentials, even for cross-origin requests.
            </summary>
        </member>
        <member name="T:NSwag.CodeGeneration.TypeScript.RequestModeType">
            <summary>Settings for the <see cref="T:NSwag.CodeGeneration.TypeScript.TypeScriptClientGenerator"/>.</summary>
        </member>
        <member name="F:NSwag.CodeGeneration.TypeScript.RequestModeType.NotSet">
            https://developer.mozilla.org/en-US/docs/Web/API/RequestInit#mode
            <summary>
            Setting will not be included.
            </summary>
        </member>
        <member name="F:NSwag.CodeGeneration.TypeScript.RequestModeType.SameOrigin">
            <summary>
            Disallows cross-origin requests. If a same-origin request is sent to a different origin, the result is a network error.
            </summary>
        </member>
        <member name="F:NSwag.CodeGeneration.TypeScript.RequestModeType.Cors">
            <summary>
        ...
        <member name="F:NSwag.CodeGeneration.TypeScript.RequestModeType.NoCors">
            <summary>
        ...
        <member name="F:NSwag.CodeGeneration.TypeScript.RequestModeType.Navigate">
            <summary>
        ...
        <member name="P:NSwag.CodeGeneration.TypeScript.TypeScriptClientGeneratorSettings.UseAbortSignal">
        ...
        <member name="P:NSwag.CodeGeneration.TypeScript.TypeScriptClientGeneratorSettings.WithCredentials">
            <summary>Gets or sets a value indicating whether to set the withCredentials flag.</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.TypeScript.TypeScriptClientGeneratorSettings.RequestCredentialsType">
            <summary>Gets or sets a value indicating the credential type for requests.</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.TypeScript.TypeScriptClientGeneratorSettings.RequestModeType">
        ...
        <member name="P:NSwag.CodeGeneration.TypeScript.TypeScriptClientGeneratorSettings.IncludeHttpContext">
            <summary>Gets a value indicating whether to include the httpContext parameter (Angular template only, default: false).</summary>
        </member>
        ...
        <member name="F:NSwag.CodeGeneration.TypeScript.TypeScriptTemplate.K6">
